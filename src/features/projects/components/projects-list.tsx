...
const ContinueCard = ({data} : {data : Doc<"projects">}) => {
    return (
        <div className="flex flex-col gap-2">
            ...
            <Button variant="outline" asChild className="h-auto items-start justify-start p-4 bg-background border flex flex-col gap-6 rounded-none">
...
const ProjectsList = ({onViewAll} :ProjectsListProps) => {
    ...
    if(projects === undefined){
        return <Spinner className="size-4 text-ring mx-auto" />
    }
        ...
        {rest.length > 0 && (
            <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <Button variant="outline" onClick={onViewAll} className="flex items-center  gap-2 text-muted-foreground text-xs hover:text-foreground transition-colors">
                        <span> View all </span>
